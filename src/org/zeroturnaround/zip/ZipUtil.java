...
/*
 * edits by https://github.com/techxplorer to remove references to org.slf4j.logger classes
 */
...
//            }
        ...
        // Add new entries
        for (Iterator<ZipEntrySource> it = entryByPath.values().iterator(); it.hasNext();) {
   ...
   */
  private static Map<String, ZipEntrySource> byPath(ZipEntrySource[] entries) {
...
//        //log.debug("Duplicate entry: {}", zipEntry.getName());
   ...
   */
  private static Map<String, ZipEntryTransformer> byPath(ZipEntryTransformerEntry[] entries) {
